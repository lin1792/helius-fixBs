...
class RpcClient {
     ...
     */
    getComputeUnits(instructions, payer, lookupTables) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    pollTransactionConfirmation(txtSig) {
        return __awaiter(this, void 0, void 0, function* () {
            // 15 second timeout
            const timeout = 15000;
     ...
     */
    createSmartTransaction(instructions, signers, lookupTables = [], feePayer) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!signers.length) {
            ...
            let { blockhash: recentBlockhash, lastValidBlockHeight } = yield this.connection.getLatestBlockhash();
            ...
            const serializedTransaction = bs58.encode(isVersioned
            ...
            const units = yield this.getComputeUnits(instructions, payerKey, isVersioned ? lookupTables : []);
            if (!units) {
     ...
     */
    sendSmartTransaction(instructions, signers, lookupTables = [], sendOptions = { skipPreflight: false }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Create a smart transaction
                const { smartTransaction: transaction, lastValidBlockHeight } = yield this.createSmartTransaction(instructions, signers, lookupTables, sendOptions.feePayer);
                ...
                while (Date.now() - startTime < timeout ||
                    ...
                    try {
                        txtSig = yield this.connection.sendRawTransaction(transaction.serialize(), Object.assign({ skipPreflight: sendOptions.skipPreflight }, sendOptions));
                        return yield this.pollTransactionConfirmation(txtSig);
                    }
                    catch (error) {
                        continue;
                    }
    ...
    createSmartTransactionWithTip(instructions, signers, lookupTables = [], tipAmount = 1000, feePayer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { smartTransaction, lastValidBlockHeight } = yield this.createSmartTransaction(instructions, signers, lookupTables, feePayer);
     ...
     * @returns {Promise<string>} - The bundle ID
     */
    sendSmartTransactionWithTip(instructions, signers, lookupTables = [], tipAmount = 1000, region = 'Default', feePayer) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!signers.length) {
                throw new Error('The transaction must have at least one signer');
            }
            // Create the smart transaction with tip based
            let { serializedTransaction, lastValidBlockHeight } = yield this.createSmartTransactionWithTip(instructions, signers, lookupTables, tipAmount, feePayer);
