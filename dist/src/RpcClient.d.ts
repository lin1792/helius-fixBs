...
export declare class RpcClient {
     ...
     */
    getComputeUnits(instructions: TransactionInstruction[], payer: PublicKey, lookupTables: AddressLookupTableAccount[]): Promise<number | null>;
    /**
     ...
     */
    pollTransactionConfirmation(txtSig: TransactionSignature): Promise<TransactionSignature>;
    /**
     ...
     */
    createSmartTransaction(instructions: TransactionInstruction[], signers: Signer[], lookupTables?: AddressLookupTableAccount[], feePayer?: Signer): Promise<{
     ...
     */
    createSmartTransactionWithTip(instructions: TransactionInstruction[], signers: Signer[], lookupTables?: AddressLookupTableAccount[], tipAmount?: number, feePayer?: Signer): Promise<{
     ...
     * @returns {Promise<string>} - The bundle ID
     */
    sendSmartTransactionWithTip(instructions: TransactionInstruction[], signers: Signer[], lookupTables?: AddressLookupTableAccount[], tipAmount?: number, region?: JitoRegion, feePayer?: Signer): Promise<string>;
    /**
